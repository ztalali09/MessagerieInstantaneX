...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/qohFOjYUtY)
...
```sh
npx nx serve MessageX
```

To create a production bundle:

```sh
npx nx build MessageX
```

To see all available targets to run for a project, run:

```sh
npx nx show project MessageX
```
